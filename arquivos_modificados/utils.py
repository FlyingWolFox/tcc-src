...
from  gymnasium.spaces import MultiBinary as gymnasium_MultiBinary
...
@flatdim.register(gymnasium_Box)
@flatdim.register(MultiBinary)
@flatdim.register(gymnasium_MultiBinary)
def _flatdim_box_multibinary(space: Union[Box, MultiBinary, gymnasium_Box, gymnasium_Multibinary]) -> int:
...
@flatten.register(gymnasium_Box)
@flatten.register(MultiBinary)
@flatten.register(gymnasium_MultiBinary)
...
@unflatten.register(gymnasium_Box)
@unflatten.register(MultiBinary)
@unflatten.register(gymnasium_MultiBinary)
def _unflatten_box_multibinary(space: Box | MultiBinary | gymnasium_Box | gymnasium_Multibinary, x: np.ndarray) -> np.ndarray:
...
@flatten_space.register(gymnasium_Box)
...
@flatten_space.register(gymnasium_MultiBinary)
